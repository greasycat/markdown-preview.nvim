...
GH_REPO="$GH_API/repos/greasycat/markdown-preview-mod.nvim"
...
for filename in "${files[@]}"; do
  GH_ASSET="https://uploads.github.com/repos/greasycat/markdown-preview-mod.nvim/releases/$id/assets?name=$filename"
